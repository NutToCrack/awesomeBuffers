...
void* consumer1(void* arg){
    while(true){
        int number = buffer1.get("Consumer 1 took ", " from buffer 1\n");
        // std::this_thread::sleep_for(std::chrono::milliseconds(MS));
    }
}
...
void* consumer2(void* arg){
    while(true){
        int number = buffer2.get("Consumer 2 took ", " from buffer 2\n");
...
void* consumer3(void* arg){
    while(true){
        int number = buffer3.get("Consumer 3 took ", " from buffer 3\n");
